...
function queryAll(selector) {
  return decorateProperty({
    descriptor: (_name) => ({
      get() {
        var _a5, _b4;
        return (_b4 = (_a5 = this.renderRoot) === null || _a5 === void 0 ? void 0 : _a5.querySelectorAll(selector)) !== null && _b4 !== void 0 ? _b4 : [];
      },
      enumerable: true,
      configurable: true
    })
  ...
  return decorateProperty({
    descriptor: (_name) => ({
      get() {
        ...
        const slotSelector = `slot${slot ? `[name=${slot}]` : ":not([name])"}`;
        const slotEl = (_a5 = this.renderRoot) === null || _a5 === void 0 ? void 0 : _a5.querySelector(slotSelector);
        return (_b4 = slotEl === null || slotEl === void 0 ? void 0 : slotEl.assignedNodes(assignedNodesOptions)) !== null && _b4 !== void 0 ? _b4 : [];
      },
      enumerable: true,
      configurable: true
    })
...
((_d = global3.litHtmlVersions) !== null && _d !== void 0 ? _d : global3.litHtmlVersions = []).push("2.8.0");
...
lit-html/development/is-server.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5FYQN2WI.js.map
