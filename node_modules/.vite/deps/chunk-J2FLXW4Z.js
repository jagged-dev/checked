...
var Tab = class extends LitElement {
  ...
  focus() {
    var _a2;
    (_a2 = this.button) == null ? void 0 : _a2.focus();
  }
  blur() {
    var _a2;
    (_a2 = this.button) == null ? void 0 : _a2.blur();
  }
  render() {
  ...
  getKeyframes() {
    ...
    const fromRect = ((_b = (_a2 = this.tabs) == null ? void 0 : _a2.previousSelectedItem) == null ? void 0 : _b.indicator.getBoundingClientRect()) ?? {};
...
@material/web/tabs/tab.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-J2FLXW4Z.js.map
